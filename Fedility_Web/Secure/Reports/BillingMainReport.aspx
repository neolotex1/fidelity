...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <div id="page-title">
        <h1 class="page-header text-overflow">
            Billing Main Report</h1>
    </div>
    <!--Breadcrumb-->
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Billing Main Report</li>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <asp:Label ID="lblSubHeading" CssClass="control-label" runat="server" Text="Report Filters"></asp:Label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <asp:Label ID="lblOrgName" runat="server" CssClass="control-label"  Text="Customer Name"></asp:Label>
                            <asp:DropDownList ID="drpOrg" runat="server" AutoPostBack="false" CssClass="form-control">
