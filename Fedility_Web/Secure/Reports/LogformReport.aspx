...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder0" runat="server">
    ...
    <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Logform Report</li>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    ...
    <div>
        ...
        <fieldset>
            ...
            <i class="fa fa-search btn-style btn-primary white">
                <asp:Button ID="btnsearchSub" runat="server" OnClick="btnsearchSub_Click1" Text="Search"  CssClass="btn btn-primary" /></i>
                <i class="fa fa-eraser btn-style btn-danger white">
                                <asp:Button ID="btnclear" runat="server" OnClick="btnclear_Click" Text="Clear"  CssClass="btn btn-danger"/></i>
            </div>
            </fieldset>
        <div class="col-md-6">
            <center>
